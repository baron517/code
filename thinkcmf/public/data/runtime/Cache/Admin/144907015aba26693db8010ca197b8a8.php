...
<body data-url="https://sy.pro.youzewang.com">
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			...
			<li><a href="<?php echo U('AutoLunbo/add');?>" target="_self">内容添加</a></li>
			<li class="active"><a href="#">内容编辑</a></li>
		</ul>
		<form action="<?php echo U('AutoLunbo/edit_post');?>" id="form" method="post" class="form-horizontal js-ajax-forms" enctype="multipart/form-data">
			<div class="row-fluid">
				<div class="span12">
