...
<body data-url="https://sy.pro.youzewang.com">
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo U('AutoType/add');?>" target="_self">添加内容</a></li>
		</ul>
		<form action="<?php echo U('AutoType/add_post');?>" id="form" method="post" class="form-horizontal js-ajax-forms" enctype="multipart/form-data">
			<div class="row-fluid">
				<div class="span12">
					<table class="table table-bordered">
                             ...
                             <tr>
    							<th width="100">标题</th>
    							<td>
    								<input type="text" style="width:400px;" id="t_title" name="post[t_title]"   value="<?php echo ($post["t_title"]); ?>" />
    							</td>
    						</tr>
                             <tr>
    							<th width="100">类型说明</th>
    							<td>
    								<input type="text" style="width:400px;" id="t_title_info" name="post[t_title_info]"   value="<?php echo ($post["t_title_info"]); ?>" />
    							</td>
    						</tr>
