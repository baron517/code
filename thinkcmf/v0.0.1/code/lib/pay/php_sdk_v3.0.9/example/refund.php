...
<body>  
	<form action="#" method="post">
        ...
        <input type="text" style="width:96%;height:35px;margin-left:2%;" value="4200000209201811252162461318" name="transaction_id" /><br /><br />
        <div style="margin-left:2%;">商户订单号：</div><br/>
        <input type="text" style="width:96%;height:35px;margin-left:2%;" value="201811251813240177" name="out_trade_no" /><br /><br />
        <div style="margin-left:2%;">订单总金额(分)：</div><br/>
        <input type="text" style="width:96%;height:35px;margin-left:2%;" value="2" name="total_fee" /><br /><br />
        <div style="margin-left:2%;">退款金额(分)：</div><br/>
        <input type="text" style="width:96%;height:35px;margin-left:2%;" value="1" name="refund_fee" /><br /><br />
		<div align="center">
