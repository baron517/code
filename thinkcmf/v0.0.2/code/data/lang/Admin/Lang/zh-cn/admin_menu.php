...
return array (
  ...
  'ADMIN_AUTOCONFIG_INDEX' => '配置管理',
  'ADMIN_AUTOLUNBO_INDEX' => '轮播管理',
  'ADMIN_AUTOMEMBER_INDEX' => '用户管理',
  'ADMIN_AUTOORDER_INDEX' => '订单管理',
  'ADMIN_AUTOSYSTEMLOG_INDEX' => '日志管理',
  'ADMIN_AUTOTYPE_INDEX' => '分类管理',
