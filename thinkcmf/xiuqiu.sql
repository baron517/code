...
INSERT INTO `tb_auth_rule` (`id`, `module`, `type`, `name`, `param`, `title`, `status`, `condition`) VALUES
...
(174, 'Admin', 'admin_url', 'admin/tag/index', NULL, '标签管理', 1, '');
...
--
-- 表的结构 `tb_common_action_log`
--

CREATE TABLE IF NOT EXISTS `tb_common_action_log` (
...
INSERT INTO `tb_links` (`link_id`, `link_url`, `link_name`, `link_image`, `link_target`, `link_description`, `link_status`, `link_rating`, `link_rel`, `listorder`) VALUES
...
CREATE TABLE IF NOT EXISTS `tb_menu` (
  ...
  KEY `model` (`model`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='后台菜单表' AUTO_INCREMENT=188 ;

--
-- 转存表中的数据 `tb_menu`
--

INSERT INTO `tb_menu` (`id`, `parentid`, `app`, `model`, `action`, `data`, `type`, `status`, `name`, `icon`, `remark`, `listorder`) VALUES
...
(187, 0, 'Admin', 'Tag', 'index', '', 1, 1, '标签管理', 'tag', '', 0);
...
CREATE TABLE IF NOT EXISTS `tb_nav` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `tb_nav` (`id`, `cid`, `parentid`, `label`, `target`, `href`, `icon`, `status`, `listorder`, `path`) VALUES
...
CREATE TABLE IF NOT EXISTS `tb_nav_cat` (
...
INSERT INTO `tb_nav_cat` (`navcid`, `name`, `active`, `remark`) VALUES
(1, '主导航', 1, '主导航');
...
CREATE TABLE IF NOT EXISTS `tb_oauth_user` (
...
INSERT INTO `tb_role` (`id`, `name`, `pid`, `status`, `remark`, `create_time`, `update_time`, `listorder`) VALUES
...
CREATE TABLE IF NOT EXISTS `tb_slide_cat` (
...
INSERT INTO `tb_tag` (`t_id`, `t_name`, `t_create_time`) VALUES
(2, '美食', '2018-06-04 11:29:08'),
(3, '运动', '2018-06-04 11:29:19');
...
INSERT INTO `tb_terms` (`term_id`, `name`, `slug`, `taxonomy`, `description`, `parent`, `count`, `path`, `seo_title`, `seo_keywords`, `seo_description`, `list_tpl`, `one_tpl`, `listorder`, `status`) VALUES
...
INSERT INTO `tb_users` (`id`, `user_login`, `user_pass`, `user_nicename`, `user_email`, `user_url`, `avatar`, `sex`, `birthday`, `signature`, `last_login_ip`, `last_login_time`, `create_time`, `user_activation_key`, `user_status`, `score`, `user_type`, `coin`, `mobile`) VALUES
(1, 'admin', '###9441c6fc947a78c8a3d00e64f81833be', 'admin', '450175465@qq.com', '', NULL, 0, '2000-01-01', NULL, '180.167.76.50', '2018-06-04 10:30:39', '2018-06-04 10:08:03', '', 1, 0, 1, 0, '');

-- --------------------------------------------------------

--
-- 表的结构 `tb_user_favorites`
--

CREATE TABLE IF NOT EXISTS `tb_user_favorites` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
